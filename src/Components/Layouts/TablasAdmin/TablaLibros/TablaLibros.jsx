...
export const TablaLibros = () => {
  ...
  let urlOrdenada =
    "https://bookerapi.onrender.com/modulos/libros/?ordering=-id_libro";
  ...
  const peticionGetNoDisponible = () => {
    ...
    axios
      .get("https://bookerapi.onrender.com/modulos/libros/?estado=IV")
      .then((response) => {
        setLibros(response.data);
      })
      .catch((error) => {
  ...
  const peticionGetDisponible = () => {
    ...
    axios
      .get("https://bookerapi.onrender.com/modulos/libros/?estado=AV")
      .then((response) => {
        setLibros(response.data);
      })
      .catch((error) => {
  ...
  const fetchCate = async () => {
    const response = await fetch(
      "https://bookerapi.onrender.com/modulos/categorias/?ordering=nombre"
    );
  ...
  const fetchAutores = async () => {
    const response = await fetch(
      "https://bookerapi.onrender.com/modulos/autores/?ordering=nombres"
    );
    const responseJSON = await response.json();
  ...
  const fetchIdioma = async () => {
    const response = await fetch(
      "https://bookerapi.onrender.com/modulos/idiomas/?ordering=nombre"
    );
    const responseJSON = await response.json();
  ...
  const fetchEditorial = async () => {
    const response = await fetch(
      "https://bookerapi.onrender.com/modulos/editoriales/?ordering=nombre"
    );
    const responseJSON = await response.json();
  ...
  const peticionGetCateLibro = (e) => {
    ...
    axios
      .get(
        "https://bookerapi.onrender.com/modulos/categorias/" + categorias.value
      )
      .then((response) => {
        cate = response.data;
  ...
  const peticionGetAutoLibro = (e) => {
    ...
    const inputAuto = document.getElementById("inputAuto");
    axios
      .get("https://bookerapi.onrender.com/modulos/autores/" + autores.value)
      .then((response) => {
        auto = response.data;
  ...
  const updateData2Estado = (libro) => {
    ...
    axios.put(endpoint, libro).then((res) => {
      peticionGet();
      console.log(res);
    });
  };
  ...
  const librosBusqueda = () => {
    ...
    if (inputBuscar.value === "" && libros22.textContent === "Libros") {
      ...
      axios
        .get(
          "https://bookerapi.onrender.com/modulos/libros/?estado=" +
            estado +
            "&search=" +
            inputBuscar.value
        )
  ...
  const [masEjemplares, setMasEjemplares] = useState(true);

  const masEjemplare = () => {
    console.log(ejeplaresInfo[0].id_libro.id_libro);
    const id_libroEjemplar = ejeplaresInfo[0].id_libro.id_libro;
    const numEjemplaresLibro =
      ejeplaresInfo[ejeplaresInfo.length - 1].num_ejemplar;
    ...
    peticionPost(nuevoEjemplar, id_libroEjemplar);
  };
  ...
  const peticionPost = async (nuevoEjemplar, id_libroEjemplar) => {
    ...
    await axios
      .post("https://bookerapi.onrender.com/modulos/ejemplares/", nuevoEjemplar)
      .then((res) => {
  ...
  const ejemplares2 = (id_libroEjemplar) => {
    ...
    axios
      .get(
        "https://bookerapi.onrender.com/modulos/ejemplares/?id_libro__id_libro=" +
          id_libroEjemplar +
          "&ordering=num_ejemplar"
      )
      .then((response) => {
  ...
  const eliminacion = (data) => {
    Swal.fire({
      title: "¿Esta seguro de eliminar este ejemplar?",
      icon: "warning",
  ...
  const peticionDelete = async (data) => {
    console.log(data);
    let endpoint =
      "https://bookerapi.onrender.com/modulos/ejemplares/" +
      data.id_ejemplar +
      "/";
              ...
              {libros.map((libro, index) => {
                ...
                return (
                  <div key={index} className="tr-1">
                    ...
                    <div className="td-2">
                      <p>{c.map((element) => element.nombre).join(", ")}</p>
                    </div>

                    <div className="td-3 tdAutoresLibro">
                      <p>{a.map((element) => element.nombres).join(", ")}</p>
                      <p>{a.map((element) => element.apellidos).join(", ")}</p>
                    </div>
                    <div className="td-6">
                      {libro.estado === "AV" ? (
                      ...
                      {libro.estado === "AV" ? (
                        <div
                          data-title="Inactivar Libro"
                          className="prueba"
                          onClick={() => updateEstado(libro)}
                        ></div>
                      ) : (
                        <div
                          data-title="Activar Libro"
                          className="prueba prueba2"
                          onClick={() => updateEstado(libro)}
                        ></div>
                      )}
                    </div>
                    ...
                    <div className="td-5">
                      <i
                        data-title="Detalles Libro"
                        onClick={() => {
                          ejemplares(libro);
                        }}
                        class="fa-solid fa-eye fa-eyeAdmin"
                      ></i>

                      <i
                        onClick={() => updateData(libro)}
                        data-title="Actualizar Libro"
        ...
        <div className="from-tablas">
          <div className="Libros-from">
            <div className="from-Titulo">
              ...
              <h1 className="btn btn-primary">ACTUALIZAR LIBRO</h1>
            </div>
            <form onSubmit={handleSubmit}>
                  ...
                  <select id="selectEdito" onChange={handleChange}>
                    ...
                    {!editorial
                      ...
                      : editorial.map((element, key) => {
                          return (
                            <option
                              className="optionSelecionar"
                              key={key}
                              value={element.id_editorial}
                            >
                              {element.nombre}
                            </option>
                          );
                  ...
                  <select id="selectIdioma" onChange={handleChange}>
                    ...
                    {!idioma
                      ...
                      : idioma.map((element, key) => {
                          return (
                            <option key={key} value={element.id_idioma}>
                              {element.nombre}
                            </option>
                          );
                        })}
              ...
              <div className="boxs-inputs">
                ...
                <i
                  className="fa-solid fa-xmark faEdit"
                  onClick={vaciarCate}
                ></i>
                <textarea
                  className="texLibro texLibroCateAuto"
                  readOnly="readOnly"
                  id="inputCate"
                  type="text"
                />
                <label id="labelCate" className="labelLibro labelLibroCate">
                  Categorias
                </label>
                <select
                  id="selecCate"
                ...
                <i
                  className="fa-solid fa-xmark fa-xmarkAuto faEdit "
                  onClick={vaciarAuto}
                ></i>
                <textarea
                  className="texLibro texLibroCateAuto"
                  ...
                  type="text"
                />
                <label id="labelAuto" className="labelLibro labelLibroAuto">
                  Autores
                </label>
                <select
                  id="selecAuto"
                  className="selectAutores"
                  onChange={(e) => {
                    peticionGetAutoLibro(e);
                  }}
                >
                  <option value="" selected></option>
                  {!autores
                    ...
                    : autores.map((element, key) => {
                        return (
                          <option key={key} value={element.id_autor}>
              ...
              <div className="boxs-inputs">
                <textarea
                  className="texLibro texLibro1"
                  required
                  name="palabras_clave"
                  onChange={handleChange}
                  value={form2.palabras_clave}
                ></textarea>
                <label className="labelLibro labelLibro1">Palabras Clave</label>
                <textarea
                  required
                  className="texLibro texLibro2"
                  name="descripcion"
                  onChange={handleChange}
              ...
              <div className="btnsFormulario">
                <button className="btnFor btn-actializar">Actualizar</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="boxTablaEjemplares">
            <div className="Tabla">
              <div className="TituloLibro">
                ...
                <button className="anadirEjemplar" onClick={masEjemplare}>
                  Añadir Ejemplar
                </button>
                    ...
                    return (
                      <div key={index} className="tr-1">
                        <div className="td-0">
                          <Imagenes
                            clase="img"
                            url={libro.id_libro.imagen_libro}
                          />
                        </div>
                        <div className="td-1">
