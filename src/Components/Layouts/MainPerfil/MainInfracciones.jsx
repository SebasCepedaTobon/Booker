...
export const MainInfracciones = () => {
  ...
  let url =
    "https://bookerapi.onrender.com/modulos/infracciones/?id_estudiante__id_estudiante=" +
    id_estudiante +
    "&estado=AV";
                    ...
                    <tr>
                      <td>
                        <Imagenes
                          clase="img-card-res"
                          url={
                            infra.id_prestamo.id_ejemplar.id_libro.imagen_libro
                          }
                        />
                      </td>
                      <td>{infra.id_prestamo.id_ejemplar.id_libro.nombre}</td>
                      <td>
                        {infra.estado === "AV" ? <p>Infracción vigente</p> : ""}
                        {infra.estado === "C" ? (
                          <p>Infracción Finalizada</p>
                        ) : (
                          ""
                        )}
                        {infra.estado === "IV" ? (
                          <p>Infracción Inactiva</p>
                        ) : (
                          ""
                        )}
                      </td>
                      <td>
                        {infra.descripcion === null ? (
                          <p>No tiene</p>
                        ) : (
