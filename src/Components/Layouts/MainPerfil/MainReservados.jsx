...
export const MainReservados = () => {
  ...
  const url =
    "https://bookerapi.onrender.com/modulos/reservas/?estado=AC&id_estudiante__id_estudiante=" +
    id_estudiante;
  ...
  const url2 = "https://bookerapi.onrender.com/modulos/reservas/";
                    ...
                    <tr className="tr-libros">
                      <td className="td-imagen">
                        {eje.map((ejempla) => (
                          <Imagenes
                            clase="img-card-res"
                            url={ejempla.id_libro.imagen_libro}
                          />
                        ))}
                      </td>
