...
export const MainPrestados = () => {
  ...
  const url =
    "https://bookerapi.onrender.com/modulos/de_prestamos/?id_estudiante__id_estudiante=" +
    id_estudiante +
    "&ordering=-fec_prestamo";
                      ...
                      <td>
                        {reserva.map((element) => {
                          return (
                            <Imagenes
                              clase="img-card-res"
                              url={element.id_ejemplar.id_libro.imagen_libro}
                            />
                          );
                        })}
                      </td>
