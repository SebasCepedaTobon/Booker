...
export const VentanaReserva2 = () => {
  ...
  const url =
    "https://bookerbackapi.herokuapp.com/modulos/estudiantes/" +
    id_estudiante +
    "/";
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.status === 200 || res.status === 201) {
          document
            .querySelector(".formulario-confirmar")
            .classList.toggle("show");
          document
            .querySelector(".formulario-contraseña")
            .classList.toggle("show");
          document
            .querySelector(".container-contraseña")
            .classList.toggle("show");
        } else {
          setState({
            error: true,
  ...
  const updateUsuario = () => {
    ...
    axios.put(endpoint, usuario).then((res) => {
      setTimeout(() => {
      ...
      <div className="container-contraseña">
        ...
        <form onSubmit={recharge} className="formulario-contraseña">
          ...
          <div className="btnsFormulario">
            <button className="btn-confirmar" onClick={btnIngresar}>
              Confirmar
            </button>
          </div>
        </form>
