...
export const Libros = ({ libro }) => {
  ...
  const url = "https://bookerapi.onrender.com/modulos/favoritos/";
  let Favoritos = [];
  ...
  const peticionFechas = () => {
    axios
      .get("https://bookerapi.onrender.com/modulos/de_prestamos/?estado=AC")
      .then((response) => {
  ...
  const peticionGetPrestamos = (id_libro) => {
    axios
      .get(
        "https://bookerapi.onrender.com/modulos/ejemplares/?estado=D&id_libro__id_libro=" +
          id_libro
      )
      .then((response) => {
      ...
      <div className="cardss">
        <div className="contenedor-libro">
          ...
          <div className="btn-card">
            <div className="container_vacio"></div>
            <div className="container_botones">
              <button
                className="btn-agLibro"
                onClick={() => {
                ...
                <div>
                  <div>
                    {prestamo.map((element2) => {
                      return (id_prestamos = element2.fec_devolucion);
                    })}
                  </div>
                </div>
              );
